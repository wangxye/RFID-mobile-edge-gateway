...
/**
 * Regarding UHF return code and description, please refer to
 * Serial_Protocol_User's_Guide_V2.38_en
 *
 */
public class CMD {
	 ...
	 * 发射通道
	 */
	public final static byte SET_Tx_Channel = (byte) 0x6B;
	/**
	 * 发射功率
	 */
	public final static byte SET_CH_Power = (byte) 0x6C;
	/**
	 * 接收通道
	 */
	public final static byte SET_Rx_Channel = (byte) 0x6D;
	/**
	 * 接收相位
	 */
	public final static byte SET_Rx_Position = (byte) 0x6E;
