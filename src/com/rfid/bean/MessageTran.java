...
public class MessageTran {
	...
	private byte btDataLen; // Length of data package, which means the byte quantity after the "length", not
							// including the "length"
	private byte btReadId; // Address of reader
	private byte btCmd; // The commend code of data package
	private byte[] btAryData; // The commend specification of data package, some commends without
								// specification
	 ...
	 * @param btAryData command parameters of data package, some commands without
	 *                  parameters
	 */
