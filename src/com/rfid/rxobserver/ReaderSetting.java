...
public class ReaderSetting {
	...
	public static class MaskMap {
		...
		/**
		 * 0x00 Inventoried S0 0x01 Inventoried S1 0x02 Inventoried S2 0x03 Inventoried
		 * S3 0x04 SL
		 */
		public byte mTarget;
		/**
		 * Tag Matches Mask | Tag Doesn’t Match Mask 0x00 Assert SL or inventoried ->A |
		 * Deassert SL or inventoried ->B 0x01 Assert SL or inventoried ->A | Do nothing
		 * 0x02 Do nothing | Deassert SL or inventoried->B 0x03 Negate SL or(A->B,B->A)
		 * | Do nothing 0x04 Deassert SL or inventoried ->B | Assert SL or
		 * inventoried->A 0x05 Deaaert SL or inventoried ->B | Do nothing 0x06 Do
		 * nothing | Assert SL or inventoried ->A 0x07 Do nothing | Negate SL or (A->B,
		 * B->A)
		 */
		public byte mAction;
		/**
		 * 0x00 Reserved for Future use 0x01 EPC 0x02 TID 0x03 USER
		 */
