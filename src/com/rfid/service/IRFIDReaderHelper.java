/**  
* <p>Title: IRFIDReaderHelper.java</p>  
* <p>Description: </p>  
 ...
 * @date 2020年4月29日
 */
public class IRFIDReaderHelper implements RFIDOperation {
	...
	private MRFIDReaderHelper mReaderHelper;
	 ...
	 * @param btReadId
	 */
	public IRFIDReaderHelper(String iP, Integer port, byte btReadId) {
		IP = iP;
		Port = port;
		this.btReadId = btReadId;
	...
	@Override
	public void connect() {
		mReaderHelper = (MRFIDReaderHelper) mConnector.connectNet(IP, Port);
	...
	public Integer setTxChannel(byte btTxChannel) {
		return mReaderHelper.setTxChannel(btReadId, (byte) btTxChannel);
	}

	public Integer setRxChannel(byte btRxMode, byte btRxChannel) {
		return mReaderHelper.setRxChannel(btReadId, btRxMode, btRxChannel);
	}
