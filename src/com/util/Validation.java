...
public class Validation {
	...
	public static final String Port = "([0-9]|[1-9]\\d{1,3}|[1-5]\\d{4}|6[0-5]{2}[0-3][0-5])";

	public static final String Chinese = "^[\u4E00-\u9FA5]+$";

	public static final String IP_Port = "(?:(?:[0,1]?\\d?\\d|2[0-4]\\d|25[0-5])\\.){3}(?:[0,1]?\\d?\\d|2[0-4]\\d|25[0-5]):\\d{0,5}";
...
//    }
	 ...
	 */
	public static boolean checkChinese(String chinese) {
		return Regular(chinese, Chinese);
	}
