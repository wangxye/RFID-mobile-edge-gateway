 ...
 * the data package by yourself.The default implement is
 * {@link #ReaderDataPackageProcess (RFID Reader)
 * #TDScannerDataPackageProcess(2D Scanner)}
 */

public abstract class DataPackageProcess extends Observable {
	/**
	 * The data return method,you can receive the return data if you implements this
	 * method.
	 * 
